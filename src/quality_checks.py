...
def run_quality_checks(con):
    ...
    # Weather features per stage: temp_mean, heat_stress_days, frost_days,
    #   GDD, total_rain, rainy_days, dry_days, max_dry_streak,
    #   humidity_mean, wind_mean = 10 features × 4 stages = 40
    # Total expected: 4 + 40 = 44
    expected_min = 44
